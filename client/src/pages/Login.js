    ...
    <div className="">
      <div className=" z-[1] relative w-full">
        <div className="login-layout mx-auto pt-[70px] px-5 max-w-[600px]">
          ...
          <div className="body mb-[50px] min-w-[320px] animated fadeIn">
            {showForm === "login" && (
              <LoginForm showForm={showForm} setShowForm={setShowForm} />
            )}
            {showForm === "signup" && (
              <SignUpForm showForm={showForm} setShowForm={setShowForm} />
            )}
            ...
            {showForm === "changepassword" && (
              <ChangePassword shwoForm={showForm} setShowForm={setShowForm} />
            )}
          </div>
          <div className="footer py-[30px]">
            <p className="mb-6 text-center text-[0.75em]">
              <a className="mr-[5px] pr-[5px] text-[#0190f3] font-bold hover:underline cursor-default hover:cursor-pointer">
                Tiếng việt
              </a>
              <a className="mr-[5px] pr-[5px] text-[#0190f3] hover:underline cursor-default hover:cursor-pointer">
                Tiếng anh
              </a>
            </p>
          </div>
